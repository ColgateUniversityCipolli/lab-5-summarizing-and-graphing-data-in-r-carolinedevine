...
% NEED TO DESCRIBE WHAT THE ESSENTIA MODEL AND LIWC IS HERE
...
\end{enumerate}
%Through this process, we used \texttt{stringr} package in R to do the majority of the manipulation of the .WAV files and extract meaningful data \citep{Wickham}. 
...
%% MODEL IS NOT RIGHT, NEED TO DBL CHECK, might be data?
...
%% THIS IS THE ESSENTIA MODEL 
%% HOW IS THIS TIED TO THE 181 songs?
...
%% NEED TO REFERENCE THIS EARLIER WHEN IT IS USED
...
%% INPUT PLOT FOR THE LAB CHALLENGE
